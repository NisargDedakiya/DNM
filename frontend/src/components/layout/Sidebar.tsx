...
const navItems = [
  ...
  {
    path: '/app/bugcrowd',
    label: 'Bugcrowd Scanner',
    exact: false,
    icon: 'M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z',
  },
  {
    path: '/app/hackerone',
    label: 'HackerOne Programs',
    exact: false,
  ...
  {
    path: '/app/exposure-grid',
    label: 'Exposure Grid',
    exact: false,
    icon: 'M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z',
  },
  {
    path: '/app/scans/88888888-8888-8888-8888-888888888888/status',
    label: 'Live Scan Status',
    exact: false,
    icon: 'M13 10V3L4 14h7v7l9-11h-7z',
  },
  {
    path: '/app/programs/99999999-9999-9999-9999-999999999999/findings',
